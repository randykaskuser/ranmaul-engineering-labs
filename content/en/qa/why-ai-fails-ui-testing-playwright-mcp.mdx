...
You can also find this skill and my other QA-focused agents in my [Claude Code Skills repository on GitHub](https://github.com/randykaskuser/qa-automation-skills).